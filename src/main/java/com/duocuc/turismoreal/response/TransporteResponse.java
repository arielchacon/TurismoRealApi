...
public class TransporteResponse {
    ...
    public TransporteResponse(int idTransporte, String direccionDesde, String direccionHasta, String horaInicio,
            Date fechaInicio, int monto, String estado, int idVehiculo) {
