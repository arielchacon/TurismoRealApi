...
public class RegistrarTransporte {
    ...
    public RegistrarTransporte(String direccionDesde, String direccionHasta, String horaInicio, Date fechaInicio,
            int monto, String estado, int idVehiculo, int idReserva) {
