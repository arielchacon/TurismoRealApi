...
public class RegistroDepartamento {
    ...
    public RegistroDepartamento(int numDepto, int numHabitaciones, int numBanios, String estado, int valor, Blob imagen,
            int dividendo, int contribucion, String disponibilidad, int idEdificio, String runFuncionario) {
